...
describe("shouldTry", () => {
  describe.each<{
    ...
    ${d("2023-01-01")} | ${holidays} | ${undefined}       | ${"weekday!"}        | ${false}
    ${d("2023-01-02")} | ${holidays} | ${undefined}       | ${"weekday!"}        | ${true}
    ${d("2023-01-04")} | ${holidays} | ${undefined}       | ${"weekday!"}        | ${false}
    ${d("2022-12-31")} | ${holidays} | ${undefined}       | ${"weekend/holiday"} | ${true}
    ${d("2023-01-01")} | ${holidays} | ${undefined}       | ${"weekend/holiday"} | ${true}
    ${d("2023-01-02")} | ${holidays} | ${undefined}       | ${"weekend/holiday"} | ${false}
    ${d("2023-01-04")} | ${holidays} | ${undefined}       | ${"weekend/holiday"} | ${true}
